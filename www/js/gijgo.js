...
gj.dialog.config = {
    base: {
         ...
         * <div id="dialog">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</div>
         * <script>
         *     gj.dialog.messages['fr-fr'].DefaultTitle = 'Titre de la boC®te de dialogue';
         *     $("#dialog").dialog({
         *         resizable: true,
         *         locale: 'fr-fr'
         *     });
...
gj.dialog.methods = {
    ...
    renderHeader: function ($dialog) {
        ...
        if ($closeButton.length === 0 && data.closeButtonInHeader) {
            $closeButton = $('<button type="button" data-role="close" title="' + gj.dialog.messages[data.locale].Close + '"><span>C—</span></button>');
...
gj.grid.config = {
    base: {
         ...
         * <table id="grid"></table>
         * <script>
         *     gj.grid.messages['fr-fr'].DisplayingRecords = 'Mes rC©sultats';
         *     $('#grid').grid({
         *         dataSource: '/DataSources/GetPlayers',
         *         uiLibrary: 'materialdesign',
         *         locale: 'fr-fr',
...
gj.grid.widget = function ($grid, arguments) {
     ...
     *         dataSource: [
     *             { 'ID': 1, 'Name': 'Hristo Stoichkov', 'PlaceOfBirth': 'Plovdiv, Bulgaria' },
     *             { 'ID': 2, 'Name': 'Ronaldo LuC­s NazC?rio de Lima', 'PlaceOfBirth': 'Rio de Janeiro, Brazil' },
     *             { 'ID': 3, 'Name': 'David Platt', 'PlaceOfBirth': 'Chadderton, Lancashire, England' }
     *         ],
     *         columns: [
     *             { field: 'ID' },
...
gj.grid.plugins.inlineEditing.config = {
    base: {
        ...
        inlineEditing: {
             ...
             *         { 'ID': 5, 'Name': 'James RodrC­guez', 'PlaceOfBirth': 'CCrcuta, Colombia' },
...
gj.grid.plugins.pagination = {
    ...
    private: {
        ...
        localizationBaseTheme: function (data) {
            if (typeof (data.pager.leftControls) === 'undefined') {
                data.pager.leftControls = [
                    $('<button title="' + gj.grid.messages[data.locale].PreviousPageTooltip + '" data-role="page-previous" class="gj-cursor-pointer"><span>A«</span></button>'),
                    ...
                    $('<button title="' + gj.grid.messages[data.locale].NextPageTooltip + '" data-role="page-next" class="gj-cursor-pointer"><span>A»</span></button> &nbsp;')
                ];
            }
            if (typeof (data.pager.rightControls) === 'undefined') {
                data.pager.rightControls = [
